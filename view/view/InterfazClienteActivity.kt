...
class InterfazClienteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = ProductoAdapter(this, listaProductos, object : ProductoAdapter.onCantidadChangeListener {
        ...
        val request = JsonArrayRequest(url,
            {response ->
                for (i in 0 until response.length()){
                    ...
                    if(bitmap != null){
                        val producto = getproductos_prueba(id, nombre, precio, imagen = bitmap, stock, cantidad = 0)
